...
def main():
    parser = argparse.ArgumentParser(description="""Counts annotation conflicts.""")
    ...
    parser.add_argument(
        ...
        dest="method",
        help=
        "Algorithm used to produce p/a file for formatting",
        type=str,
    ...
    anno_conlfict_count = count_differences(gene_data, args.pa_file, 
        col_skip=col_skip, sep=sep, method=args.method)
